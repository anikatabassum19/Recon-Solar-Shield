...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span1, file$5, 68, 12, 2054);
    			attr_dev(span2, "class", "status-label");
    			add_location(span2, file$5, 69, 12, 2090);
    			attr_dev(span3, "class", "bx-gsm-value");
    			add_location(span3, file$5, 71, 16, 2187);
    			attr_dev(span4, "class", "status-text");
    			add_location(span4, file$5, 70, 12, 2144);
    			attr_dev(div0, "class", "status-icon");
    			add_location(div0, file$5, 67, 8, 2016);
    			attr_dev(span5, "class", "square");
    			add_location(span5, file$5, 76, 12, 2325);
    			attr_dev(span6, "class", "status-label");
    			add_location(span6, file$5, 77, 12, 2361);
    			attr_dev(span7, "class", "by-gsm-value");
    			add_location(span7, file$5, 79, 16, 2458);
    			attr_dev(span8, "class", "status-text");
    			add_location(span8, file$5, 78, 12, 2415);
    			attr_dev(div1, "class", "status-icon");
    			add_location(div1, file$5, 75, 8, 2287);
    			attr_dev(span9, "class", "square");
    			add_location(span9, file$5, 84, 12, 2596);
    			attr_dev(span10, "class", "status-label");
    			add_location(span10, file$5, 85, 12, 2632);
    			attr_dev(span11, "class", "bz-gsm-value");
    			add_location(span11, file$5, 87, 16, 2729);
    			attr_dev(span12, "class", "status-text");
    			add_location(span12, file$5, 86, 12, 2686);
    			attr_dev(div2, "class", "status-icon");
    			add_location(div2, file$5, 83, 8, 2558);
    			attr_dev(span13, "class", "square");
    			add_location(span13, file$5, 92, 12, 2867);
    			attr_dev(span14, "class", "status-label");
    			add_location(span14, file$5, 93, 12, 2903);
    			attr_dev(span15, "class", "bt-value");
    			add_location(span15, file$5, 95, 16, 2996);
    			attr_dev(span16, "class", "status-text");
    			add_location(span16, file$5, 94, 12, 2953);
    			attr_dev(div3, "class", "status-icon");
    			add_location(div3, file$5, 91, 8, 2829);
    			add_location(h41, file$5, 99, 8, 3089);
    			attr_dev(span17, "class", "square");
    			add_location(span17, file$5, 104, 16, 3218);
    			attr_dev(span18, "class", "status-label");
    			add_location(span18, file$5, 105, 16, 3258);
    			attr_dev(span19, "class", "status-text");
    			add_location(span19, file$5, 106, 16, 3318);
    			attr_dev(div4, "class", "status-icon");
    			add_location(div4, file$5, 103, 12, 3176);
    			attr_dev(span20, "class", "square");
    			add_location(span20, file$5, 109, 16, 3445);
    			attr_dev(span21, "class", "status-label");
    			add_location(span21, file$5, 110, 16, 3485);
    			attr_dev(span22, "class", "status-text");
    			add_location(span22, file$5, 111, 16, 3546);
    			attr_dev(div5, "class", "status-icon");
    			add_location(div5, file$5, 108, 12, 3403);
    			attr_dev(span23, "class", "square");
    			add_location(span23, file$5, 114, 16, 3674);
    			attr_dev(span24, "class", "status-label");
    			add_location(span24, file$5, 115, 16, 3714);
    			attr_dev(span25, "class", "status-text");
    			add_location(span25, file$5, 116, 16, 3774);
    			attr_dev(div6, "class", "status-icon");
    			add_location(div6, file$5, 113, 12, 3632);
    			attr_dev(span26, "class", "square");
    			add_location(span26, file$5, 119, 16, 3901);
    			attr_dev(span27, "class", "status-label");
    			add_location(span27, file$5, 120, 16, 3941);
    			attr_dev(span28, "class", "status-text");
    			add_location(span28, file$5, 121, 16, 4002);
    			attr_dev(div7, "class", "status-icon");
    			add_location(div7, file$5, 118, 12, 3859);
    			attr_dev(span29, "class", "square");
    			add_location(span29, file$5, 124, 16, 4130);
    			attr_dev(span30, "class", "status-label");
    			add_location(span30, file$5, 125, 16, 4170);
    			attr_dev(span31, "class", "status-text");
    			add_location(span31, file$5, 126, 16, 4233);
    			attr_dev(div8, "class", "status-icon");
    			add_location(div8, file$5, 123, 12, 4088);
    			attr_dev(span32, "class", "square");
    			add_location(span32, file$5, 129, 16, 4363);
    			attr_dev(span33, "class", "status-label");
    			add_location(span33, file$5, 130, 16, 4403);
    			attr_dev(span34, "class", "status-text");
    			add_location(span34, file$5, 131, 16, 4466);
    			attr_dev(div9, "class", "status-icon");
    			add_location(div9, file$5, 128, 12, 4321);
    			attr_dev(span35, "class", "square");
    			add_location(span35, file$5, 134, 16, 4596);
    			attr_dev(span36, "class", "status-label");
    			add_location(span36, file$5, 135, 16, 4636);
    			attr_dev(span37, "class", "status-text");
    			add_location(span37, file$5, 136, 16, 4693);
    			attr_dev(div10, "class", "status-icon");
    			add_location(div10, file$5, 133, 12, 4554);
    			attr_dev(span38, "class", "square");
    			add_location(span38, file$5, 139, 16, 4817);
    			attr_dev(span39, "class", "status-label");
    			add_location(span39, file$5, 140, 16, 4857);
    			attr_dev(span40, "class", "status-text");
    			add_location(span40, file$5, 141, 16, 4913);
    			attr_dev(div11, "class", "status-icon");
    			add_location(div11, file$5, 138, 12, 4775);
    			attr_dev(span41, "class", "square");
    			add_location(span41, file$5, 144, 16, 5036);
    			attr_dev(span42, "class", "status-label");
    			add_location(span42, file$5, 145, 16, 5076);
    			attr_dev(span43, "class", "status-text");
    			add_location(span43, file$5, 146, 16, 5136);
    			attr_dev(div12, "class", "status-icon");
    			add_location(div12, file$5, 143, 12, 4994);
    			attr_dev(span44, "class", "square");
    			add_location(span44, file$5, 149, 16, 5263);
    			attr_dev(span45, "class", "status-label");
    			add_location(span45, file$5, 150, 16, 5303);
    			attr_dev(span46, "class", "status-text");
    			add_location(span46, file$5, 151, 16, 5365);
    			attr_dev(div13, "class", "status-icon");
    			add_location(div13, file$5, 148, 12, 5221);
    			attr_dev(div14, "class", "left-float svelte-xpvn32");
    			add_location(div14, file$5, 101, 8, 3126);
    			...
    			add_location(div16, file$5, 157, 4, 5523);
    			attr_dev(h20, "class", "svelte-xpvn32");
    			add_location(h20, file$5, 172, 24, 6077);
    			attr_dev(span47, "class", "bullet");
    			add_location(span47, file$5, 175, 32, 6222);
    			add_location(li0, file$5, 174, 28, 6185);
    			attr_dev(span48, "class", "bullet");
    			add_location(span48, file$5, 178, 32, 6372);
    			add_location(li1, file$5, 177, 28, 6335);
    			attr_dev(span49, "class", "bullet");
    			add_location(span49, file$5, 181, 32, 6531);
    			add_location(li2, file$5, 180, 28, 6494);
    			attr_dev(ul0, "class", "data-fields");
    			add_location(ul0, file$5, 173, 24, 6132);
    			attr_dev(div17, "class", "info-item");
    			add_location(div17, file$5, 171, 20, 6029);
    			attr_dev(h21, "class", "svelte-xpvn32");
    			add_location(h21, file$5, 188, 24, 6780);
    			attr_dev(span50, "class", "bullet");
    			add_location(span50, file$5, 191, 32, 6926);
    			add_location(li3, file$5, 190, 28, 6889);
    			attr_dev(span51, "class", "bullet");
    			add_location(span51, file$5, 193, 32, 7037);
    			add_location(li4, file$5, 193, 28, 7033);
    			attr_dev(ul1, "class", "data-fields");
    			add_location(ul1, file$5, 189, 24, 6836);
    			attr_dev(div18, "class", "info-item");
    			add_location(div18, file$5, 187, 20, 6732);
    			attr_dev(h22, "class", "svelte-xpvn32");
    			add_location(h22, file$5, 198, 24, 7209);
    			attr_dev(span52, "class", "bullet");
    			add_location(span52, file$5, 201, 32, 7353);
    			add_location(li5, file$5, 200, 28, 7316);
    			attr_dev(span53, "class", "bullet");
    			add_location(span53, file$5, 204, 32, 7499);
    			add_location(li6, file$5, 203, 28, 7462);
    			attr_dev(ul2, "class", "data-fields");
    			add_location(ul2, file$5, 199, 24, 7263);
    			attr_dev(div19, "class", "info-item");
    			add_location(div19, file$5, 197, 20, 7161);
    			attr_dev(h23, "class", "svelte-xpvn32");
    			add_location(h23, file$5, 210, 24, 7708);
    			attr_dev(span54, "class", "bullet");
    			add_location(span54, file$5, 213, 32, 7848);
    			add_location(li7, file$5, 212, 28, 7811);
    			attr_dev(span55, "class", "bullet");
    			add_location(span55, file$5, 217, 32, 8033);
    			add_location(li8, file$5, 216, 28, 7996);
    			attr_dev(ul3, "class", "data-fields");
    			add_location(ul3, file$5, 211, 24, 7758);
    			attr_dev(div20, "class", "info-item");
    			add_location(div20, file$5, 209, 20, 7660);
    			attr_dev(h24, "class", "svelte-xpvn32");
    			add_location(h24, file$5, 223, 24, 8248);
    			attr_dev(span56, "class", "bullet");
    			add_location(span56, file$5, 226, 32, 8396);
    			add_location(li9, file$5, 225, 28, 8359);
    			attr_dev(span57, "class", "bullet");
    			add_location(span57, file$5, 230, 32, 8582);
    			add_location(li10, file$5, 229, 28, 8545);
    			attr_dev(ul4, "class", "data-fields");
    			add_location(ul4, file$5, 224, 24, 8306);
    			attr_dev(div21, "class", "info-item");
    			add_location(div21, file$5, 222, 20, 8200);
    			attr_dev(h25, "class", "svelte-xpvn32");
    			add_location(h25, file$5, 237, 24, 8831);
    			attr_dev(span58, "class", "bullet");
    			add_location(span58, file$5, 239, 32, 8948);
    			add_location(li11, file$5, 239, 28, 8944);
    			attr_dev(span59, "class", "bullet");
    			add_location(span59, file$5, 241, 32, 9058);
    			add_location(li12, file$5, 240, 28, 9021);
    			attr_dev(ul5, "class", "data-fields");
    			add_location(ul5, file$5, 238, 24, 8891);
    			attr_dev(div22, "class", "info-item");
    			add_location(div22, file$5, 236, 20, 8783);
    			...
    			add_location(div23, file$5, 167, 16, 5812);
    			attr_dev(div24, "class", "info-grid");
    			add_location(div24, file$5, 164, 12, 5734);
    			attr_dev(div25, "class", "info-container");
    			add_location(div25, file$5, 162, 8, 5648);
    			attr_dev(div26, "class", "right-float svelte-xpvn32");
    			add_location(div26, file$5, 160, 4, 5582);
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	const solarWindApiUrl = baseApiUrl$1 + "/api/satellitedata/ace";
    	let earthData = {};
    	let solarWindData = {};
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span59 = element("span");
    			t113 = text(" Geomagnetic Disturbances:\n                                Low");
    			add_location(br, file$4, 63, 12, 1933);
    			set_style(span0, "color", "#ffcc00");
    			add_location(span0, file$4, 64, 12, 1951);
    			add_location(h40, file$4, 62, 8, 1906);
    			attr_dev(span1, "class", "square");
    			add_location(span1, file$4, 68, 12, 2057);
    			attr_dev(span2, "class", "status-label");
    			add_location(span2, file$4, 69, 12, 2093);
    			attr_dev(span3, "class", "bx-gsm-value");
    			add_location(span3, file$4, 71, 16, 2190);
    			attr_dev(span4, "class", "status-text");
    			add_location(span4, file$4, 70, 12, 2147);
    			attr_dev(div0, "class", "status-icon");
    			add_location(div0, file$4, 67, 8, 2019);
    			attr_dev(span5, "class", "square");
    			add_location(span5, file$4, 76, 12, 2328);
    			attr_dev(span6, "class", "status-label");
    			add_location(span6, file$4, 77, 12, 2364);
    			attr_dev(span7, "class", "by-gsm-value");
    			add_location(span7, file$4, 79, 16, 2461);
    			attr_dev(span8, "class", "status-text");
    			add_location(span8, file$4, 78, 12, 2418);
    			attr_dev(div1, "class", "status-icon");
    			add_location(div1, file$4, 75, 8, 2290);
    			attr_dev(span9, "class", "square");
    			add_location(span9, file$4, 84, 12, 2599);
    			attr_dev(span10, "class", "status-label");
    			add_location(span10, file$4, 85, 12, 2635);
    			attr_dev(span11, "class", "bz-gsm-value");
    			add_location(span11, file$4, 87, 16, 2732);
    			attr_dev(span12, "class", "status-text");
    			add_location(span12, file$4, 86, 12, 2689);
    			attr_dev(div2, "class", "status-icon");
    			add_location(div2, file$4, 83, 8, 2561);
    			attr_dev(span13, "class", "square");
    			add_location(span13, file$4, 92, 12, 2870);
    			attr_dev(span14, "class", "status-label");
    			add_location(span14, file$4, 93, 12, 2906);
    			attr_dev(span15, "class", "bt-value");
    			add_location(span15, file$4, 95, 16, 2999);
    			attr_dev(span16, "class", "status-text");
    			add_location(span16, file$4, 94, 12, 2956);
    			attr_dev(div3, "class", "status-icon");
    			add_location(div3, file$4, 91, 8, 2832);
    			add_location(h41, file$4, 99, 8, 3092);
    			attr_dev(span17, "class", "square");
    			add_location(span17, file$4, 104, 16, 3221);
    			attr_dev(span18, "class", "status-label");
    			add_location(span18, file$4, 105, 16, 3261);
    			attr_dev(span19, "class", "status-text");
    			add_location(span19, file$4, 106, 16, 3321);
    			attr_dev(div4, "class", "status-icon");
    			add_location(div4, file$4, 103, 12, 3179);
    			attr_dev(span20, "class", "square");
    			add_location(span20, file$4, 109, 16, 3448);
    			attr_dev(span21, "class", "status-label");
    			add_location(span21, file$4, 110, 16, 3488);
    			attr_dev(span22, "class", "status-text");
    			add_location(span22, file$4, 111, 16, 3549);
    			attr_dev(div5, "class", "status-icon");
    			add_location(div5, file$4, 108, 12, 3406);
    			attr_dev(span23, "class", "square");
    			add_location(span23, file$4, 114, 16, 3677);
    			attr_dev(span24, "class", "status-label");
    			add_location(span24, file$4, 115, 16, 3717);
    			attr_dev(span25, "class", "status-text");
    			add_location(span25, file$4, 116, 16, 3777);
    			attr_dev(div6, "class", "status-icon");
    			add_location(div6, file$4, 113, 12, 3635);
    			attr_dev(span26, "class", "square");
    			add_location(span26, file$4, 119, 16, 3904);
    			attr_dev(span27, "class", "status-label");
    			add_location(span27, file$4, 120, 16, 3944);
    			attr_dev(span28, "class", "status-text");
    			add_location(span28, file$4, 121, 16, 4005);
    			attr_dev(div7, "class", "status-icon");
    			add_location(div7, file$4, 118, 12, 3862);
    			attr_dev(span29, "class", "square");
    			add_location(span29, file$4, 124, 16, 4133);
    			attr_dev(span30, "class", "status-label");
    			add_location(span30, file$4, 125, 16, 4173);
    			attr_dev(span31, "class", "status-text");
    			add_location(span31, file$4, 126, 16, 4236);
    			attr_dev(div8, "class", "status-icon");
    			add_location(div8, file$4, 123, 12, 4091);
    			attr_dev(span32, "class", "square");
    			add_location(span32, file$4, 129, 16, 4366);
    			attr_dev(span33, "class", "status-label");
    			add_location(span33, file$4, 130, 16, 4406);
    			attr_dev(span34, "class", "status-text");
    			add_location(span34, file$4, 131, 16, 4469);
    			attr_dev(div9, "class", "status-icon");
    			add_location(div9, file$4, 128, 12, 4324);
    			attr_dev(span35, "class", "square");
    			add_location(span35, file$4, 134, 16, 4599);
    			attr_dev(span36, "class", "status-label");
    			add_location(span36, file$4, 135, 16, 4639);
    			attr_dev(span37, "class", "status-text");
    			add_location(span37, file$4, 136, 16, 4696);
    			attr_dev(div10, "class", "status-icon");
    			add_location(div10, file$4, 133, 12, 4557);
    			attr_dev(span38, "class", "square");
    			add_location(span38, file$4, 139, 16, 4820);
    			attr_dev(span39, "class", "status-label");
    			add_location(span39, file$4, 140, 16, 4860);
    			attr_dev(span40, "class", "status-text");
    			add_location(span40, file$4, 141, 16, 4916);
    			attr_dev(div11, "class", "status-icon");
    			add_location(div11, file$4, 138, 12, 4778);
    			attr_dev(span41, "class", "square");
    			add_location(span41, file$4, 144, 16, 5039);
    			attr_dev(span42, "class", "status-label");
    			add_location(span42, file$4, 145, 16, 5079);
    			attr_dev(span43, "class", "status-text");
    			add_location(span43, file$4, 146, 16, 5139);
    			attr_dev(div12, "class", "status-icon");
    			add_location(div12, file$4, 143, 12, 4997);
    			attr_dev(span44, "class", "square");
    			add_location(span44, file$4, 149, 16, 5266);
    			attr_dev(span45, "class", "status-label");
    			add_location(span45, file$4, 150, 16, 5306);
    			attr_dev(span46, "class", "status-text");
    			add_location(span46, file$4, 151, 16, 5368);
    			attr_dev(div13, "class", "status-icon");
    			add_location(div13, file$4, 148, 12, 5224);
    			attr_dev(div14, "class", "left-float svelte-1hg7coc");
    			add_location(div14, file$4, 101, 8, 3129);
    			set_style(div15, "font-size", "18px");
    			attr_dev(div15, "class", "left-float svelte-1hg7coc");
    			add_location(div15, file$4, 61, 4, 1849);
    			attr_dev(div16, "class", "gap svelte-1hg7coc");
    			add_location(div16, file$4, 157, 4, 5526);
    			attr_dev(h20, "class", "svelte-1hg7coc");
    			add_location(h20, file$4, 172, 24, 6080);
    			attr_dev(span47, "class", "bullet");
    			add_location(span47, file$4, 175, 32, 6225);
    			add_location(li0, file$4, 174, 28, 6188);
    			attr_dev(span48, "class", "bullet");
    			add_location(span48, file$4, 178, 32, 6375);
    			add_location(li1, file$4, 177, 28, 6338);
    			attr_dev(span49, "class", "bullet");
    			add_location(span49, file$4, 181, 32, 6534);
    			add_location(li2, file$4, 180, 28, 6497);
    			attr_dev(ul0, "class", "data-fields");
    			add_location(ul0, file$4, 173, 24, 6135);
    			attr_dev(div17, "class", "info-item");
    			add_location(div17, file$4, 171, 20, 6032);
    			attr_dev(h21, "class", "svelte-1hg7coc");
    			add_location(h21, file$4, 188, 24, 6783);
    			attr_dev(span50, "class", "bullet");
    			add_location(span50, file$4, 191, 32, 6929);
    			add_location(li3, file$4, 190, 28, 6892);
    			attr_dev(span51, "class", "bullet");
    			add_location(span51, file$4, 193, 32, 7040);
    			add_location(li4, file$4, 193, 28, 7036);
    			attr_dev(ul1, "class", "data-fields");
    			add_location(ul1, file$4, 189, 24, 6839);
    			attr_dev(div18, "class", "info-item");
    			add_location(div18, file$4, 187, 20, 6735);
    			attr_dev(h22, "class", "svelte-1hg7coc");
    			add_location(h22, file$4, 198, 24, 7212);
    			attr_dev(span52, "class", "bullet");
    			add_location(span52, file$4, 201, 32, 7356);
    			add_location(li5, file$4, 200, 28, 7319);
    			attr_dev(span53, "class", "bullet");
    			add_location(span53, file$4, 204, 32, 7502);
    			add_location(li6, file$4, 203, 28, 7465);
    			attr_dev(ul2, "class", "data-fields");
    			add_location(ul2, file$4, 199, 24, 7266);
    			attr_dev(div19, "class", "info-item");
    			add_location(div19, file$4, 197, 20, 7164);
    			attr_dev(h23, "class", "svelte-1hg7coc");
    			add_location(h23, file$4, 210, 24, 7711);
    			attr_dev(span54, "class", "bullet");
    			add_location(span54, file$4, 213, 32, 7851);
    			add_location(li7, file$4, 212, 28, 7814);
    			attr_dev(span55, "class", "bullet");
    			add_location(span55, file$4, 217, 32, 8036);
    			add_location(li8, file$4, 216, 28, 7999);
    			attr_dev(ul3, "class", "data-fields");
    			add_location(ul3, file$4, 211, 24, 7761);
    			attr_dev(div20, "class", "info-item");
    			add_location(div20, file$4, 209, 20, 7663);
    			attr_dev(h24, "class", "svelte-1hg7coc");
    			add_location(h24, file$4, 223, 24, 8251);
    			attr_dev(span56, "class", "bullet");
    			add_location(span56, file$4, 226, 32, 8399);
    			add_location(li9, file$4, 225, 28, 8362);
    			attr_dev(span57, "class", "bullet");
    			add_location(span57, file$4, 230, 32, 8585);
    			add_location(li10, file$4, 229, 28, 8548);
    			attr_dev(ul4, "class", "data-fields");
    			add_location(ul4, file$4, 224, 24, 8309);
    			attr_dev(div21, "class", "info-item");
    			add_location(div21, file$4, 222, 20, 8203);
    			attr_dev(h25, "class", "svelte-1hg7coc");
    			add_location(h25, file$4, 237, 24, 8834);
    			attr_dev(span58, "class", "bullet");
    			add_location(span58, file$4, 239, 32, 8951);
    			add_location(li11, file$4, 239, 28, 8947);
    			attr_dev(span59, "class", "bullet");
    			add_location(span59, file$4, 241, 32, 9061);
    			add_location(li12, file$4, 240, 28, 9024);
    			attr_dev(ul5, "class", "data-fields");
    			add_location(ul5, file$4, 238, 24, 8894);
    			attr_dev(div22, "class", "info-item");
    			add_location(div22, file$4, 236, 20, 8786);
    			set_style(div23, "float", "right");
    			set_style(div23, "margin-left", "20px");
    			set_style(div23, "display", "grid");
    			set_style(div23, "grid-template-columns", "repeat(3, 1fr)");
    			set_style(div23, "grid-gap", "20px");
    			attr_dev(div23, "class", "info-container");
    			add_location(div23, file$4, 167, 16, 5815);
    			attr_dev(div24, "class", "info-grid");
    			add_location(div24, file$4, 164, 12, 5737);
    			attr_dev(div25, "class", "info-container");
    			add_location(div25, file$4, 162, 8, 5651);
    			attr_dev(div26, "class", "right-float svelte-1hg7coc");
    			add_location(div26, file$4, 160, 4, 5585);
    			attr_dev(main, "class", "dis-sat-container svelte-1hg7coc");
    			add_location(main, file$4, 58, 0, 1778);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */ const requestAnimFrame = function() {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(450:4) {#if displayACESatellite}",
    		ctx
    	});
    ...
    // (454:8) {#if displayDSCOVRSatellite}
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(454:8) {#if displayDSCOVRSatellite}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 474, 8, 14895);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 472, 8, 14836);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(472:4) {#if magneticReconnection}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas0, file$2, 188, 4, 4357);
    			attr_dev(div0, "class", "chart-items svelte-1q7sc0s");
    			add_location(div0, file$2, 187, 2, 4327);
    			attr_dev(canvas1, "id", "orientationChart");
    			add_location(canvas1, file$2, 191, 4, 4469);
    			attr_dev(div1, "class", "chart-items svelte-1q7sc0s");
    			add_location(div1, file$2, 190, 2, 4439);
    			attr_dev(div2, "class", "chart-container svelte-1q7sc0s");
    			add_location(div2, file$2, 186, 0, 4295);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(strong, file$1, 62, 20, 1935);
    			attr_dev(li, "class", "svelte-1ldpxrv");
    			add_location(li, file$1, 61, 16, 1910);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$1, 51, 16, 1634);
    			...
    			add_location(h2, file$1, 57, 8, 1802);
    			attr_dev(ul, "class", "svelte-1ldpxrv");
    			add_location(ul, file$1, 59, 8, 1842);
    			attr_dev(section, "class", "sat-info");
    			add_location(section, file$1, 56, 4, 1767);
